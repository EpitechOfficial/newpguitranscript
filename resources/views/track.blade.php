<x-app-layout :pageName="'Track-Application'">
    <style>
        .cardEmpty {
        ...
        <div class="card mb-2 w-100">
            ...
            @else
                <div class="card-body h-100 w-100">
                    <div class="program">
                        <h1 class="mb-0 pb-0 display-4" id="title">Track Transcript Request</h1>
                    </div>
                    <br>
                                        ...
                                        <tr>
                                            ...
                                            <td class="status-td">
                                                @switch($record->status)
                                                    ...
                                                    @case(1)
                                                        <button class="btn btn-warning btn-sm w-auto text-nowrap">
                                                            Processing
                                                        </button>
                                                    @break
                                                    ...
                                                    @default
                                                        <button class="btn btn-danger btn-sm w-auto text-nowrap">
                                                            Error
                                                        </button>
                                                @endswitch
                                            </td>
                    ...
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h2 class="modal-title" id="viewModalLabel"><strong> Transcript Request Details
                                    </strong></h2>
